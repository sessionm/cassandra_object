...
module CassandraObject
  module NestedAttributes #:nodoc:
    ...
    #
    #   class Book < CassandraObject::Base
    #     has_one :author
    #     has_many :pages
    #
    ...
    #
    #   class Member < CassandraObject::Base
    #     has_one :avatar
    ...
    # by the parents save method. See CassandraObject::AutosaveAssociation.
    #
    ...
    # Returns CassandraObject::AutosaveAssociation::marked_for_destruction? It's
